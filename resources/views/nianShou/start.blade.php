...
<dl style="width:100%;color:#FFF;font-size:1.3em;text-align:center;line-height:1.5em;margin-top:0;font-weight: bold">
    <marquee direction="left" height="30" scrollamount="5">
        <p style="text-align: center">通知：应广大用户的要求，此次年兽活动时间暂延长至2016年3月20日。请相互转告！</p>
    </marquee>
</dl>
...
<div id="explain" style="height: 50%">
    <dl style="font-size:0.8em;color:#FFF; font-weight: bold; line-height:1.8em;height: 65%;overflow-y:auto;">
        ...
        <dd>3.每个人每个手机号只能参加一次兑奖，对违反规定者将取消其兑奖资格，没收手机并处罚。</dd>
        <dd>4.用户可点击“西安华东万悦城”微信公众账号页面下方“兑奖中心”查看所获现金及实物礼品。</dd>
        <dd>5.活动期间，用户全程免费参与，获奖用户将获得唯一兑换码和二维码，兑换码和二维码仅限本人兑换，转发无效。</dd>
        <dd>6.获得奖金与礼品仅限活动时间内有效，活动时间结束后未兑换过期作废，视为自愿放弃。</dd>
        <dd>7.活动详细规则以店内公告为准；</dd>
        <dd>8.中奖价值超过1000元以上，按照国家相关法律法规中奖人需缴纳金额20%的个人所得税。</dd>
        <dd>9.线上游戏参与时间：2016年1月26日-2016年2月24日</dd>
        <dd>10.客服电话：029-68290999</dd>
        <dd>11.地址：长乐西路朝阳门外300米（原华东品牌服饰加盟广场）</dd>
        <dd>12.商户优惠券的使用，以店内通知为准</dd>
