...
<head>
    ...
    <style>
        *{margin:0; padding:0; -webkit-tap-highlight-color:rgba(0,0,0,0);}
        ...
        img{max-width:100%;}
        #hear{display:none; width:60%; margin-top:22%; -webkit-animation-name:myfirst; -webkit-animation-duration:0.5s; -webkit-animation-play-state:paused; -webkit-animation-iteration-count:3;}
    ...
    <script type="text/javascript">
        ...
        wx.ready(function(){
            var share = {
                ...
                link: 'http://hdwyc.3pdj.com/nianshou', // 分享链接
...
<div style="text-align:right;margin:3% 0 10%;"><img src="" style="width:24%;margin-right:10%;" id="m" /></div>
<div id="m1">当前参与人数{{ $userNum }}人<br />距活动结束还有{{ \Carbon\Carbon::create(2016,2,8)->diffInDays() }}天</div>
<div id="p1">
    <div style="text-align:center;">
        <img src="/Images/shou.png" id="hear" />
